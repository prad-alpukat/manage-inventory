<?php 
    ...
    if ($kd_distributor == " " || empty($kd_distributor) || $nama_distributor == " " || empty($nama_distributor)) {
        $response = ['response'=>'negative','alert'=>'Lengkapi field'];
    }else{
                $value = "'$kd_distributor','$nama_distributor','$alamat','$nohp_distributor'";
                $response = $dis->insert($table,$value,"?page=viewDistributor");
    ...
    if ($kd_distributor == "" || $nama_distributor == "") {
        $response = ['response'=>'negative','alert'=>'lengkapi field'];
    }else{
                $value = "kd_distributor='$kd_distributor',nama_distributor='$nama_distributor'";
                $response = $dis->update($table,$value,"kd_distributor",$_GET['id'],"?page=viewDistributor");
            }
        }
 ?>
