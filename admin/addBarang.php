<?php 
    ...
    $autokode = $br->autokode("table_brg","kd_barang","BR");
    $waktu    = date("Y-m-d");
    ...
    if ($kode_barang == " " || $nama_barang == " " || $merek_barang == " " || $distributor == " " || $stok == " ") {
        $response = ['response'=>'negative','alert'=>'lengkapi field'];
    }else{
        if ($stok < 0 || $stok == 0) {
            $response = ['response'=>'negative','alert'=>' stok tidak boleh 0 atau <'];
        }else{
                $value = "'$kode_barang','$nama_barang','$merek_barang','$distributor','$waktu','$stok'";
