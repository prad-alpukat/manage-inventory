...
// Ambil data nama ketua dari tabel table_ketua
$sql_ketua = "SELECT nama_ketua FROM table_ketua";
$result_ketua = mysqli_query($con, $sql_ketua);

// Buat array untuk menyimpan nama-nama ketua
$nama_ketua_list = array();

// Periksa apakah query berhasil dieksekusi
if ($result_ketua) {
    // Loop melalui hasil query dan tambahkan nama ketua ke dalam array
    while ($row_ketua = mysqli_fetch_assoc($result_ketua)) {
        $nama_ketua_list[] = $row_ketua['nama_ketua'];
    }
} else {
    // Jika query gagal, berikan pesan kesalahan
    die("Query to fetch ketua names failed");
}
                            ...
                            <form method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <!-- Dropdown untuk nama ketua -->
                                        <div class="form-group">
                                            <label for="">Nama Ketua</label>
                                            <select class="form-control" name="nama_ketua">
                                                <?php foreach ($nama_ketua_list as $nama_ketua_item) : ?>
                                                    <option value="<?php echo $nama_ketua_item; ?>"><?php echo $nama_ketua_item; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
